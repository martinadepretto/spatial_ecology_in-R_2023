...
# Setting a variation of colors for the map - colorRampPalette
...
# multiframe to plot two or more characteristics together - mfrow
par(mfrow=c(1,2))    #one row, two column
plot(densitymap)
plot(elev)

par(mfrow=c(2,1))   #two row, one column
plot(densitymap)
plot(elev)
